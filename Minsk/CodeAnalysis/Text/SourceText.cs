    ...
    public sealed class SourceText
    {
        ...
        public static ImmutableArray<TextLine> ParseLines(SourceText sourceText, string text)
        {
            ...
            while (position < text.Length)
            {
                ...
                {
                    AddLine(result, sourceText, position, lineStart, lineBreakWith);
        ...
        private static void AddLine(ImmutableArray<TextLine>.Builder result, SourceText sourceText, int position, int lineStart, int lineBreakWith)
        {
            var lineLength = position - lineStart;
            var lineLengthIncludingLineBreak = lineLength + lineBreakWith;
